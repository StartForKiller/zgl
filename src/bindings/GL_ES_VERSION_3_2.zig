...
// generator zig-opengl/bin/Debug/net7.0/generator.dll OpenGL-Registry/xml/gl.xml GL_ES_VERSION_3_2.zig GL_ES_VERSION_3_2
//
...
pub fn blendBarrier() callconv(.C) void {
    return @call(.always_tail, function_pointers.glBlendBarrier, .{});
}
...
pub fn primitiveBoundingBox(_minX: GLfloat, _minY: GLfloat, _minZ: GLfloat, _minW: GLfloat, _maxX: GLfloat, _maxY: GLfloat, _maxZ: GLfloat, _maxW: GLfloat) callconv(.C) void {
    return @call(.always_tail, function_pointers.glPrimitiveBoundingBox, .{_minX, _minY, _minZ, _minW, _maxX, _maxY, _maxZ, _maxW});
}
...
pub fn load(load_ctx: anytype, get_proc_address: fn(@TypeOf(load_ctx), [:0]const u8) ?FunctionPointer) !void {
    ...
    if(get_proc_address(load_ctx, "glBlendBarrier")) |proc| {
        function_pointers.glBlendBarrier = @ptrCast(proc);
    } else {
        log.err("entry point glBlendBarrier not found!", .{});
        success = false;
    }
    ...
    if(get_proc_address(load_ctx, "glPrimitiveBoundingBox")) |proc| {
        function_pointers.glPrimitiveBoundingBox = @ptrCast(proc);
    } else {
        log.err("entry point glPrimitiveBoundingBox not found!", .{});
        success = false;
    }
...
const function_signatures = struct {
    ...
    const glBlendBarrier = fn() callconv(.C) void;
    ...
    const glPrimitiveBoundingBox = fn(_minX: GLfloat, _minY: GLfloat, _minZ: GLfloat, _minW: GLfloat, _maxX: GLfloat, _maxY: GLfloat, _maxZ: GLfloat, _maxW: GLfloat) callconv(.C) void;
...
const function_pointers = struct {
    ...
    var glBlendBarrier: *const function_signatures.glBlendBarrier = undefined;
    ...
    var glPrimitiveBoundingBox: *const function_signatures.glPrimitiveBoundingBox = undefined;
